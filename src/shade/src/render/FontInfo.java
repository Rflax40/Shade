...
public class FontInfo {
	...
	public static class GlyphInfo {
		...
		public GlyphInfo(char c, short x, short y, short w, short h, short xo, short yo, short xa,
			short p) {
			character = c;
			xCoord = x;
			yCoord = y;
	...
	public FontInfo(String ff, short fs, boolean b, boolean i, boolean u, short lh, short bw,
		int cc, GlyphInfo[] ch) {
		fontFace = ff;
		fontSize = fs;
		bold = b;
